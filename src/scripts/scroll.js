...
import animationData from "../assets/Lottie/World_Cup.json";
...
lottieContainer.style.transform = `translate(${pos.lottie.current.x}px,
${pos.lottie.current.y}px)`;
