...
const ROLE_ROUTES: Record<string, string[]> = {
  admin: ['/admin', '/api/admin', '/api/tournaments', '/api/teams', '/api/matches', '/api/invitations', '/api/players', '/api/team-requests', '/api/notifications', '/api/referees', '/api/referee', '/api/stats'],
