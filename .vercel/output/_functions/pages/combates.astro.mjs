...
const $$DuelCard = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="duel-card group" data-astro-cid-wmnxlmri> <div class="duel-inner" data-astro-cid-wmnxlmri> <div class="duel-stage" data-astro-cid-wmnxlmri>${stage}</div> <div class="duel-teams" data-astro-cid-wmnxlmri> <a${addAttribute(`/jugadores/${t1?.id || "#"}`, "href")} class="duel-side duel-side--left" data-astro-cid-wmnxlmri> <div class="duel-avatar-wrap" data-astro-cid-wmnxlmri> <div class="duel-avatar-bg" data-astro-cid-wmnxlmri></div> <img class="duel-avatar"${addAttribute(teamLogo, "src")}${addAttribute(t1?.name || "Equipo", "alt")} loading="lazy" data-astro-cid-wmnxlmri> </div> <span class="duel-name" data-astro-cid-wmnxlmri>${t1?.name || "???"}</span> </a> <div class="duel-vs" aria-hidden="true" data-astro-cid-wmnxlmri> <span class="duel-vs-circle" data-astro-cid-wmnxlmri> <span class="duel-vs-text" data-astro-cid-wmnxlmri>VS</span> </span> <div class="duel-vs-line" data-astro-cid-wmnxlmri></div> </div> <a${addAttribute(`/jugadores/${t2?.id || "#"}`, "href")} class="duel-side duel-side--right" data-astro-cid-wmnxlmri> <div class="duel-avatar-wrap" data-astro-cid-wmnxlmri> <div class="duel-avatar-bg" data-astro-cid-wmnxlmri></div> <img class="duel-avatar"${addAttribute(teamLogo, "src")}${addAttribute(t2?.name || "Equipo", "alt")} loading="lazy" data-astro-cid-wmnxlmri> </div> <span class="duel-name" data-astro-cid-wmnxlmri>${t2?.name || "???"}</span> </a> </div> <div class="duel-meta" data-astro-cid-wmnxlmri> <span class="duel-meta-item" data-astro-cid-wmnxlmri> <svg class="duel-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-astro-cid-wmnxlmri> <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" data-astro-cid-wmnxlmri></path> </svg> ${date} · ${hour} </span> <span class="duel-meta-item" data-astro-cid-wmnxlmri> <svg class="duel-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" data-astro-cid-wmnxlmri> <path stroke-linecap="round" stroke-linejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" data-astro-cid-wmnxlmri></path> <path stroke-linecap="round" stroke-linejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" data-astro-cid-wmnxlmri></path> </svg> ${venue} </span> </div> <div class="duel-meta" data-astro-cid-wmnxlmri> <a${addAttribute(`/combate/${id}`, "href")} class="boxer-detail-cta boxer-detail-cta-ghost relative z-10 mt-1" data-astro-cid-wmnxlmri>
VER DUELO
</a> </div> </div> </div> `;
