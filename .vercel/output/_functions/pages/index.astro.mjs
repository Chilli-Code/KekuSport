import { c as createComponent, m as maybeRenderHead, d as addAttribute, r as renderComponent, a as renderTemplate, b as createAstro, e as renderScript, F as Fragment } from '../chunks/astro/server_DpPHlMO2.mjs';
import 'kleur/colors';
import { $ as $$Layout } from '../chunks/Layout_BFkBUtQq.mjs';
import { T as TEAMS, $ as $$FighterSelector } from '../chunks/teams_B6XkBB_y.mjs';
/* empty css                                 */
import 'clsx';
...
const $$TeamsHero = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="relative flex min-h-screen w-full" data-astro-cid-suuyupxo> <div class="mask-fade-bottom absolute inset-0 w-full bg-[url('/images/herp.jpeg')] bg-cover bg-center" data-astro-cid-suuyupxo></div> <div class="group/hero relative flex w-full flex-col items-center p-2 md:p-8 text-center" data-astro-cid-suuyupxo> <div id="landing"${addAttribute([
