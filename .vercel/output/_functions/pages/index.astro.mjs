import { b as createAstro, c as createComponent, m as maybeRenderHead, d as addAttribute, g as renderScript, a as renderTemplate, r as renderComponent, h as renderTransition, F as Fragment } from '../chunks/astro/server_B1RsrXwl.mjs';
import 'kleur/colors';
...
const $$Astro$3 = createAstro("https://la-velada-clone.vercel.app/");
const $$BoxerCard = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots);
  Astro2.self = $$BoxerCard;
  const { id, name, versus, class: extraClass } = Astro2.props;
...
const $$FighterSelector = createComponent(($$result, $$props, $$slots) => {
  ...
  const { id, name, boxerCardClass, versus } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div> ${renderComponent($$result, "BoxerCard", $$BoxerCard, { "id": id, "name": name, "class": `peer ${boxerCardClass}`, "versus": versus })} <div id="fighter-container" class="pointer-events-none absolute inset-0 flex-col items-center hidden peer-hover:flex peer-focus:flex peer-focus-visible:flex"> <div class="relative top-96 mx-auto h-[4.5rem] flex w-full items-center justify-center z-1 animate-zoom-in"> <!-- <img
        ...
        fetchpriority='low'
      /> --> <div class="relative"> <h3 class="text-7xl font-semibold tracking-wide drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] bg-gradient-to-r from-purple-500 to-emerald-500 bg-clip-text text-transparent relative z-10"> ${name} </h3> <div class="absolute inset-0 bg-emerald-500/80 blur-2xl -z-0 opacity-50 group-hover:opacity-100 transition-opacity"></div> </div> </div> <div class="mask-fade-bottom relative bottom-0 mx-auto h-[80vh] flex w-full items-center justify-center animate-slide-up-fade"> <img${addAttribute(`hero-image-${id}`, "data-id")}${addAttribute(`/images/fighters/big/${id}.webp`, "src")}${addAttribute(name, "alt")} decoding="async" class="w-auto h-full absolute" fetchpriority="low"${addAttribute(renderTransition($$result, "pxwu2rux", "", `image-${id}`), "data-astro-transition-scope")}> </div> </div> </div>`;
  ...
  const simulatedStandings = [
    {
      ...
      team: {
        ...
        name: "Peereira",
        manager: "Pablo Ramos",
        logo: "/images/fighters/cards/peereira.webp"
      },
      played: 10,
      wins: 8,
      draws: 1,
    ...
    },
    {
      ...
      team: {
        ...
        name: "Rivaldios",
        manager: "Rivaldo",
        logo: "/images/fighters/cards/rivaldios.webp"
      },
      played: 10,
      wins: 7,
      draws: 2,
    ...
    },
    {
      ...
      team: {
        ...
        name: "DjMaRIIO",
        manager: "DjMaRIIO",
        logo: "/images/fighters/cards/djmariio.webp"
      },
      played: 10,
      wins: 6,
      draws: 1,
    ...
    },
    {
      ...
      team: {
        ...
        name: "Ibai Llanos",
        manager: "Ibai",
        logo: "/images/fighters/cards/ibai.webp"
      },
      played: 10,
      wins: 5,
      draws: 2,
    ...
    },
    {
      ...
      team: {
        ...
        name: "Spursito",
        manager: "Spursito",
        logo: "/images/fighters/cards/spursito.webp"
      },
      played: 10,
      wins: 4,
      draws: 1,
    ...
    },
    {
      ...
      team: {
        ...
        name: "Xocas",
        manager: "Xocas",
        logo: "/images/fighters/cards/xocas.webp"
      },
      played: 10,
      wins: 3,
      draws: 2,
    ...
    },
    {
      ...
      team: {
        ...
        name: "Carreraa",
        manager: "Carreraa",
        logo: "/images/fighters/cards/carreraa.webp"
      },
      played: 10,
      wins: 2,
      draws: 2,
    ...
    },
    {
      ...
      team: {
        ...
        name: "ElXokas",
        manager: "Xokas",
        logo: "/images/fighters/cards/elxokas.webp"
      },
      played: 10,
      wins: 1,
      draws: 1,
...
const $$TournamentBracket = createComponent(($$result, $$props, $$slots) => {
  ...
  const {
    ...
    groupA = [
      { id: "peereira", name: "Peereira", logo: "/images/fighters/cards/peereira.webp", points: 9 },
      { id: "djmariio", name: "DjMaRIIO", logo: "/images/fighters/cards/djmariio.webp", points: 6 },
      { id: "xocas", name: "Xocas", logo: "/images/fighters/cards/xocas.webp", points: 3 },
      { id: "elxokas", name: "ElXokas", logo: "/images/fighters/cards/elxokas.webp", points: 0 }
    ],
    groupB = [
      { id: "ibai", name: "Ibai Llanos", logo: "/images/fighters/cards/ibai.webp", points: 9 },
      { id: "spursito", name: "Spursito", logo: "/images/fighters/cards/spursito.webp", points: 6 },
      { id: "carreraa", name: "Carreraa", logo: "/images/fighters/cards/carreraa.webp", points: 3 },
      { id: "rivaldios", name: "Rivaldios", logo: "/images/fighters/cards/rivaldios.webp", points: 0 }
    ],
    groupC = [
      { id: "grefg", name: "ElGrefg", logo: "/images/fighters/cards/grefg.webp", points: 9 },
      { id: "vegetta", name: "Vegetta777", logo: "/images/fighters/cards/vegetta.webp", points: 6 },
      { id: "illojuan", name: "IlloJuan", logo: "/images/fighters/cards/illojuan.webp", points: 3 },
      { id: "agustin51", name: "Agustin51", logo: "/images/fighters/cards/agustin51.webp", points: 0 }
    ],
    groupD = [
      { id: "auronplay", name: "AuronPlay", logo: "/images/fighters/cards/auronplay.webp", points: 9 },
      { id: "rubius", name: "Rubius", logo: "/images/fighters/cards/rubius.webp", points: 6 },
      { id: "messi", name: "Messi", logo: "/images/fighters/cards/messi.webp", points: 3 },
      { id: "cristiano", name: "Cristiano", logo: "/images/fighters/cards/cristiano.webp", points: 0 }
    ],
    leftQuarterFinals = [
      { id: "lqf1", team1: { id: "peereira", name: "Peereira", points: 9 }, team2: { id: "spursito", name: "Spursito", points: 6 }, score1: 3, score2: 1, winner: "team1" },
      { id: "lqf2", team1: { id: "ibai", name: "Ibai Llanos", points: 9 }, team2: { id: "djmariio", name: "DjMaRIIO", points: 6 }, score1: 3, score2: 1, winner: "team1" }
    ],
    rightQuarterFinals = [
      { id: "rqf1", team1: { id: "grefg", name: "ElGrefg", points: 9 }, team2: { id: "rubius", name: "Rubius", points: 6 }, score1: 2, score2: 0, winner: "team1" },
      { id: "rqf2", team1: { id: "auronplay", name: "AuronPlay", points: 9 }, team2: { id: "vegetta", name: "Vegetta777", points: 6 }, score1: 2, score2: 0, winner: "team1" }
    ],
    leftSemiFinal = {
      id: "lsf",
      team1: { id: "peereira", name: "Peereira", points: 9 },
      team2: { id: "ibai", name: "Ibai Llanos", points: 9 },
      score1: 2,
      score2: 1,
      winner: "team1"
    },
    rightSemiFinal = {
      id: "rsf",
      team1: { id: "grefg", name: "ElGrefg", points: 9 },
      team2: { id: "auronplay", name: "AuronPlay", points: 9 },
      score1: 3,
      score2: 2,
      winner: "team1"
    },
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Hero", $$Hero, {})} ${renderComponent($$result2, "StandingsTable", $$StandingsTable, { "title": "TORNEO PES - TEMPORADA 1" })} ${maybeRenderHead()}<section class="py-12 px-4"> ${renderComponent($$result2, "TournamentBracket", $$TournamentBracket, { "title": "PLAYOFF", "finalDate": "30 DE MAYO", "finalLocation": "BUDAPEST" })} </section>  ${renderComponent($$result2, "Video", $$Videos, {})} ` })}`;
